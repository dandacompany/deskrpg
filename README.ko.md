...
- 버전: `v2026.924.1` — 직원마다 스킬을 관리합니다: 공식 목록·Skills Hub·URL 에서 설치하고, 편집·켜고 끄기·삭제하고, curator 를 실행합니다. 화면 문구·NPC 잡담·회의 요약·CLI 출력이 사용자 언어(영어·한국어·일본어·중국어)를 따릅니다. 플러그인을 모든 직원에게 적용하는 워커 적용은 설치 마법사에서 공개하고 켜는 선택 사항입니다. 아래 안내의 플러그인 0.16.0과 정책 지원 Hermes core가 필요합니다.
