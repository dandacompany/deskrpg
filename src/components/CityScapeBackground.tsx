...
const PRESETS = [
  ...
  },
  {
    ...
    layers: {
      ...
      clothes: { itemKey: "torso_clothes_longsleeve2_buttoned", variant: "white" },
      legs: { itemKey: "legs_formal", variant: "charcoal" },
      shoes: { itemKey: "feet_boots_basic", variant: "black" },
    },
  },
  {
    bodyType: "female",
    layers: {
      ...
      eye_color: { itemKey: "eye_color", variant: "green" },
      hair: { itemKey: "hair_bangslong", variant: "raven" },
      clothes: { itemKey: "torso_clothes_tshirt_scoop", variant: "pink" },
  ...
  },
  {
    ...
    layers: {
      ...
      eye_color: { itemKey: "eye_color", variant: "brown" },
      hair: { itemKey: "hair_bedhead", variant: "black" },
      clothes: { itemKey: "torso_clothes_shortsleeve_polo", variant: "navy" },
  ...
  },
  {
    ...
    layers: {
      body: { itemKey: "body", variant: "light" },
      eye_color: { itemKey: "eye_color", variant: "blue" },
      hair: { itemKey: "hair_bob_side_part", variant: "ginger" },
      clothes: { itemKey: "torso_clothes_blouse_longsleeve", variant: "white" },
  ...
  },
  {
    ...
    layers: {
      body: { itemKey: "body", variant: "light" },
      eye_color: { itemKey: "eye_color", variant: "blue" },
      hair: { itemKey: "hair_bangsshort", variant: "sandy" },
      clothes: { itemKey: "torso_clothes_longsleeve", variant: "maroon" },
...
export default function CityScapeBackground() {
  ...
  const midWindows = useMemo(
    () => [
      generateWindows(48, 56, 0.92),
      generateWindows(56, 32, 0.92),
      generateWindows(32, 48, 0.92),
      generateWindows(40, 56, 0.92),
      generateWindows(44, 52, 0.92),
      generateWindows(28, 56, 0.92),
    ],
    [],
  );
  const nearWindows = useMemo(
    () => [
      generateWindows(64, 48, 0.88),
      generateWindows(52, 40, 0.88),
      generateWindows(72, 44, 0.88),
    ],
    [],
  );
  ...
  useEffect(() => {
    ...
    carsRef.current = [createCar(w, 1), createCar(w, -1), { ...createCar(w, 1), x: w * 0.3 }];
  ...
  return (
    <div
      ...
      style={{
        background: "linear-gradient(180deg,#030712 0%,#0a1128 30%,#111d3a 60%,#162040 100%)",
      }}
    >
      {/* Stars */}
      ...
      <div className="absolute left-0 right-0" style={{ bottom: "18%" }}>
        {[
          ...
          <div
            ...
            style={{ left: b.left, width: b.width, height: b.height, background: "#060b18" }}
          >
            {b.beacon && (
        ...
        <div
          ...
          style={{ left: "42vw", width: "5vw", height: "25vh", background: "#080d1a" }}
        >
          ...
          return (
            ...
            >
              {b.billboard && (
                ...
                >
                  <div
                    className="w-full h-full flex flex-col items-center justify-center animate-screen-shift relative"
                    style={{ background: "linear-gradient(135deg,#1e1b4b,#312e81,#4338ca)" }}
                  >
                    <div
                      className="text-[clamp(8px,1.2vw,14px)] font-black text-indigo-200 font-mono tracking-widest"
                      style={{ textShadow: "0 0 8px rgba(199,210,254,0.5)" }}
                    >
                      DeskRPG
                    </div>
                    <div className="text-[clamp(4px,0.5vw,7px)] text-indigo-400 tracking-widest">
                      {t("auth.subtitle")}
                    </div>
                    <div
              ...
              >
                {midWindows[i].map((cell, j) => (
                  <div
                    key={j}
                    className={cell.on ? "animate-window-flicker" : ""}
                    style={{
                      aspectRatio: "1",
                      borderRadius: 0.5,
      ...
      <div className="absolute left-0 right-0" style={{ bottom: "18%" }}>
        {[
          ...
          return (
            ...
            >
              <div
                className="grid gap-[3px] p-[5px] mt-2"
                ...
                {nearWindows[i].map((cell, j) => (
                  <div
                    ...
                    style={{
                      ...
                      boxShadow:
                        cell.on && parseFloat(cell.opacity) > 0.5
                          ? `0 0 3px ${windowColor}0.3)`
                          : "none",
                      animationDelay: cell.on ? `${cell.delay}s` : undefined,
                    }}
                  />
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", gap: 1 }}>
              <div style={{ width: 1.5, height: 1, background: "#000" }} />
              <div style={{ width: 1.5, height: 1, background: "#000" }} />
            </div>
            <div style={{ width: 4, height: 1, background: "#000" }} />
          </div>
      ...
      <div
        ...
        style={{
          height: "18%",
          background: "linear-gradient(180deg,#141c2e,#111827)",
          borderTop: "2px solid #2d3a50",
        }}
      >
      ...
      {["8vw", "35vw", "62vw", "90vw"].map((left, i) => (
        <div key={i} className="absolute" style={{ bottom: "18%", left }}>
          <div
            className="w-[10px] h-1 rounded-full mx-auto"
            style={{
              background: "#fbbf24",
              boxShadow: "0 0 14px rgba(251,191,36,0.5),0 0 35px rgba(251,191,36,0.12)",
            }}
          />
      ...
      <style jsx global>{`
        ...
        .animate-screen-shift {
          animation: screen-shift 8s ease infinite;
        }
        @keyframes scan-line {
          0% {
            top: -2px;
        ...
        .animate-window-flicker {
          animation: window-flicker 15s ease-in-out infinite;
        }
        @keyframes flag-wave {
          0%,
          100% {
          ...
          75% {
            transform: scaleX(0.97) skewY(0.5deg);
          }
        }
        .animate-flag-wave {
