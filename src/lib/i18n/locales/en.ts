...
const en: Record<string, string> = {
  ...
  "profiles.page.subtitle": "Choose a profile from a connected gateway to manage your NPC’s name and appearance. Each NPC’s identity and appearance belong to that Hermes profile.",
  ...
  "profiles.gateways.emptyBody": "NPCs start with profiles on a connected Hermes gateway. Connect a gateway or obtain shared access to manage its profiles and appearances here.",
  ...
  "profiles.gateway.sharedHint": "This gateway is shared with you. Its owner manages profile registration and appearance.",
  "profiles.noGateway": "No gateway was given.",
  "profiles.new.title": "New employee",
  "profiles.new.subtitle": "One employee is one Hermes profile. Name it, write its persona, then sign that employee in to a model.",
  ...
  "meeting.recordedParticipantsNote": "The recorded participant count reflects the participants present when the meeting started.",
